...
class YOLOClient:
    ...
    async def detect_objects(
        ...
        return await self._call_tool('detect_objects', {
    ...
    async def classify_image(
        ...
        return await self._call_tool('classify_image', {
            'image_data': image_str,
            'model_name': model_name,
            'top_k': top_k,
            'save_results': save_results,
    ...
    async def train_model(
        ...
        """
        return await self._call_tool('train_model', {
    ...
    async def validate_model(
        ...
        """
        return await self._call_tool('validate_model', {
    ...
    async def start_camera_detection(
        ...
        """
        return await self._call_tool('start_camera_detection', {
            'model_name': model_name,
            'confidence': confidence,
            'camera_id': camera_id
        })
